...
if __name__ == '__main__':
    ...
    mlp('fmnist_mlp', X_train.reshape(60000, 784), Y_train, X_test.reshape(10000, 784), Y_test)
    cnn('fmnist_cnn', X_train.reshape(60000, 28, 28, 1), Y_train, X_test.reshape(10000, 28, 28, 1), Y_test)
